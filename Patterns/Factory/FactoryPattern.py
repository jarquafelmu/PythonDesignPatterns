...
Factories allow you to group objects that belong together
...
def main(exporter_factory: ExporterFactory) -> None:
    ...
    # dependency inversion: the factory itself is an abstract class
...
if __name__ == "__main__":
    ...
    # injecting the dependency on the factory into the main function
    main(fac)
